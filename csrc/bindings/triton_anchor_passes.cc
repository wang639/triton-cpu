...
#include "triton-anchor/RegisterTritonLinalgDialects.h"
...
void init_triton_anchor_passes_triton_to_linalg(py::module_ &m) {
  ...
  ADD_PASS_WRAPPER_0("add_wrap_func_body_with_single_block", createWrapFuncBodyWithSingleBlockPass);
  ADD_PASS_WRAPPER_0("add_pointer_strength_reduction", createPointerStrengthReductionPass);
