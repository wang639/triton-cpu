...
#include "triton-anchor/Dialect/LinalgExt/IR/LinalgExtOpsDialect.h.inc"

//===----------------------------------------------------------------------===//
// LinalgExt Dialect Enum Attributes
//===----------------------------------------------------------------------===//

#include "triton-anchor/Dialect/LinalgExt/IR/LinalgExtEnums.h.inc"

#define GET_OP_CLASSES
#include "triton-anchor/Dialect/LinalgExt/IR/LinalgExtOps.h.inc"

#define GET_OP_CLASSES
#include "triton-anchor/Dialect/LinalgExt/IR/LinalgExtStructedOps.h.inc"
